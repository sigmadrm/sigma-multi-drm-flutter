...
+ (instancetype)makeWithUri:(NSString *)uri
                httpHeaders:(NSDictionary<NSString *, NSString *> *)httpHeaders drmConfiguration:(nullable NSDictionary<NSString *, NSString *> *)drmConfiguration {
...
+ (FVPCreationOptions *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.drmConfiguration = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray<id> *)list {
