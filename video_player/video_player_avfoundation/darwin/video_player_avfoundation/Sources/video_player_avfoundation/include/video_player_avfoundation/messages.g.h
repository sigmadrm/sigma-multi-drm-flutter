...
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithUri:(NSString *)uri httpHeaders:(NSDictionary<NSString *, NSString *> *)httpHeaders
            drmConfiguration:(nullable NSDictionary<NSString *, NSString *> *)drmConfiguration;
@property(nonatomic, copy) NSString *uri;
@property(nonatomic, copy) NSDictionary<NSString *, NSString *> *httpHeaders;
@proerty(nonatomic, copy, nullable) NSDictionary<NSString *, NSString *> *drmConfiguration;
@end
